...
export default function CheckoutModal({
  ...
  const clearOrderItems = useNewOrderStore((state) => state.clearOrderItems);
  ...
  const handleCreateNewOrder = () => {
    ...
    createOrderMutation.mutate(
      ...
      {
        onSuccess(data) {
          const order_code = data.data.data.code;
          toast.success(`Đơn #${order_code} vừa được tạo thành công!`, {
            duration: 10000,
          });
          clearOrderItems();
          onClose();
        ...
        onError(error) {
          ...
          toast.error(`Tạo đơn thất bại: ${errorMessage}`, {
            duration: 10000,
          });
        },
      },
